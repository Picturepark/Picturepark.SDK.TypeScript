...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v13.0.0.0 (NJsonSchema v10.0.17.0 (Newtonsoft.Json v11.0.0.0)) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class OutputFormatClient extends PictureparkClientBase {
    ...
    protected processGet(response: Response): Promise<OutputFormat> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : <OutputFormat>JSON.parse(_responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<OutputFormat>(<any>null);
    }
