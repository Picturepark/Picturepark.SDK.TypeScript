...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.12.14.0 (NJsonSchema v9.10.18.0 (Newtonsoft.Json v9.0.0.0)) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class ContentClient extends PictureparkClientBase {
    ...
    createMany(contentCreateRequests: ContentCreateRequest[] | null): Promise<BusinessProcess> {
        ...
        const content_ = JSON.stringify(contentCreateRequests);
    ...
    protected processCreate(response: Response): Promise<ContentDetail> {
        ...
        if (status === 200) {
            ...
            result400 = _responseText === "" ? null : <BusinessProcessWaitTimeoutException>JSON.parse(_responseText, this.jsonParseReviver);
    ...
    protected processUpdateMetadataMany(response: Response): Promise<BusinessProcess> {
        ...
        if (status === 200) {
            ...
            return response.text().then((_responseText) => {
            let result404: any = null;
            result404 = _responseText === "" ? null : <ContentsNotFoundException>JSON.parse(_responseText, this.jsonParseReviver);
            return throwException("A server error occurred.", status, _responseText, _headers, result404);
            });
        } else if (status === 500) {
            return response.text().then((_responseText) => {
...
export class ListItemClient extends PictureparkClientBase {
    ...
    protected processGet(response: Response): Promise<ListItemDetail> {
        ...
        if (status === 200) {
            ...
            return response.text().then((_responseText) => {
            let result404: any = null;
            result404 = _responseText === "" ? null : <ListItemNotFoundException>JSON.parse(_responseText, this.jsonParseReviver);
            return throwException("A server error occurred.", status, _responseText, _headers, result404);
            });
        } else if (status === 500) {
            return response.text().then((_responseText) => {
    ...
    createMany(listItemCreateRequests: ListItemCreateRequest[] | null): Promise<BusinessProcess> {
        ...
        const content_ = JSON.stringify(listItemCreateRequests);
...
export class ShareClient extends PictureparkClientBase {
    ...
    protected processCreate(response: Response): Promise<CreateShareResult> {
        ...
        if (status === 404) {
            ...
            result403 = _responseText === "" ? null : <PermissionException>JSON.parse(_responseText, this.jsonParseReviver);
