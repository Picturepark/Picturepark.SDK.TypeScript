...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.12.11.0 (NJsonSchema v9.10.12.0 (Newtonsoft.Json v9.0.0.0)) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class PermissionClient extends PictureparkClientBase {
    ...
    hasUserRight(userRight: UserRight): Promise<boolean> {
        ...
        if (userRight === undefined || userRight === null)
            throw new Error("The parameter 'userRight' must be defined and cannot be null.");
        else
            url_ += "userRight=" + encodeURIComponent("" + userRight) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
