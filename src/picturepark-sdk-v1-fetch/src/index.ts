...
export class SchemaClient extends PictureparkClientBase {
     ...
     */
    update(schemaId: string, schema: SchemaUpdateRequest | null, timeout?: string | null | undefined): Promise<SchemaUpdateResult> {
        let url_ = this.baseUrl + "/v1/schemas/{schemaId}?";
        if (schemaId === undefined || schemaId === null)
            throw new Error("The parameter 'schemaId' must be defined.");
        url_ = url_.replace("{schemaId}", encodeURIComponent("" + schemaId)); 
     ...
     */
    create(schema: SchemaCreateRequest | null, timeout?: string | null | undefined): Promise<SchemaCreateResult> {
        let url_ = this.baseUrl + "/v1/schemas?";
        if (timeout !== undefined)
            url_ += "timeout=" + encodeURIComponent("" + timeout) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
export class UserClient extends PictureparkClientBase {
     ...
     */
    create(request: UserCreateRequest | null): Promise<UserDetail> {
     ...
     */
    update(userId: string, userUpdatableDetail: UserUpdatableDetail | null): Promise<UserDetail> {
        let url_ = this.baseUrl + "/v1/users/{userId}";
        if (userId === undefined || userId === null)
            throw new Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId)); 
     ...
     */
    lock(userId: string, userLockRequest: UserLockRequest | null): Promise<void> {
     ...
     */
    review(userId: string, userReviewRequest: UserReviewRequest | null): Promise<void> {
     ...
     * Deletes a user
     */
    delete(userId: string, userDeactivateRequest: UserDeletionRequest | null): Promise<void> {
