...
export class ContentClient {
    ...
    protected processAggregate(response: Response): Promise<ObjectAggregationResult | null> {
        ...
        if (status === 200) {
            ...
            result200 = responseText === "" ? null : <ObjectAggregationResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((responseText) => {
            let result500: PictureparkException | null = null;
            result500 = responseText === "" ? null : <PictureparkException>JSON.parse(responseText, this.jsonParseReviver);
            return throwException("A server error occurred.", status, responseText, result500);
            });
    ...
    protected processCreateDownloadLink(response: Response): Promise<ContentBatchDownloadItem | null> {
        ...
        if (status === 200) {
            ...
            result200 = responseText === "" ? null : <ContentBatchDownloadItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((responseText) => {
    ...
    protected processCreateContent(response: Response): Promise<ContentDetail | null> {
        ...
        if (status === 200) {
            ...
            result200 = responseText === "" ? null : <ContentDetail>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((responseText) => {
    ...
    protected processGet(response: Response): Promise<ContentDetail | null> {
        ...
        if (status === 404) {
            ...
            result404 = responseText === "" ? null : <ContentNotFoundException>JSON.parse(responseText, this.jsonParseReviver);
            return throwException("A server error occurred.", status, responseText, result404);
            });
        } else if (status === 200) {
            return response.text().then((responseText) => {
            let result200: ContentDetail | null = null;
    ...
    protected processSearch(response: Response): Promise<ContentSearchResult | null> {
        ...
        if (status === 200) {
            ...
            result200 = responseText === "" ? null : <ContentSearchResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((responseText) => {
    ...
    protected processUpdateFile(response: Response): Promise<BusinessProcessViewItem | null> {
        ...
        if (status === 200) {
            ...
            result200 = responseText === "" ? null : <BusinessProcessViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((responseText) => {
...
export class BusinessProcessClient {
    ...
    markAsStarted(processId: string): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMarkAsStarted(_response);
        });
    }
    ...
    protected processWaitForStates(response: Response): Promise<BusinessProcessWaitResult | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <BusinessProcessWaitResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class DocumentHistoryClient {
    ...
    protected processGet(response: Response): Promise<DocumentHistoryViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <DocumentHistoryViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processGetDifferenceLatest(response: Response): Promise<DocumentHistoryDifferenceViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <DocumentHistoryDifferenceViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class ListItemClient {
    ...
    protected processCreate(response: Response): Promise<ListItemDetail | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <ListItemDetail>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processSearch(response: Response): Promise<BaseResultOfListItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <BaseResultOfListItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class SchemaClient {
    ...
    protected processGet(response: Response): Promise<SchemaDetailViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <SchemaDetailViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processExists(response: Response): Promise<ExistsResponse | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <ExistsResponse>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processSearch(response: Response): Promise<BaseResultOfSchemaViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <BaseResultOfSchemaViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class PermissionClient {
    ...
    protected processSearchContentPermissions(response: Response): Promise<PermissionSetSearchResult | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <PermissionSetSearchResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processGetContentPermissions(response: Response): Promise<ContentPermissionSetDetailViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <ContentPermissionSetDetailViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processGetSchemaPermissions(response: Response): Promise<SchemaPermissionSetDetailViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <SchemaPermissionSetDetailViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class PublicAccessClient {
    ...
    protected processGetShare(response: Response): Promise<ShareBaseDetailViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <ShareBaseDetailViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class ShareClient {
    ...
    protected processCreate(response: Response): Promise<CreateShareResult | null> {
        ...
        if (status === 404) {
            ...
            result200 = responseText === "" ? null : <CreateShareResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((responseText) => {
    ...
    protected processSearch(response: Response): Promise<BaseResultOfShareBaseViewItem | null> {
        ...
        if (status === 200) {
            ...
            result200 = responseText === "" ? null : <BaseResultOfShareBaseViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((responseText) => {
...
export class TransferClient {
    ...
    protected processCreate(response: Response): Promise<TransferViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <TransferViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processGet(response: Response): Promise<TransferDetailViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <TransferDetailViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processGetFile(response: Response): Promise<FileTransferDetailViewItem | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <FileTransferDetailViewItem>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processSearch(response: Response): Promise<TransferSearchResult | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <TransferSearchResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
    ...
    protected processSearchFiles(response: Response): Promise<FileTransferSearchResult | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <FileTransferSearchResult>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
...
export class UserClient {
    ...
    protected processGetChannels(response: Response): Promise<ChannelViewItem[] | null> {
        ...
        if (status === 500) {
            ...
            result200 = responseText === "" ? null : <ChannelViewItem[]>JSON.parse(responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((responseText) => {
