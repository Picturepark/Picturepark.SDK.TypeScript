...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.17.21.0 (NJsonSchema v9.10.65.0 (Newtonsoft.Json v9.0.0.0)) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class ContentClient extends PictureparkClientBase {
     ...
     * @param patterns (optional) List of display pattern types. Resolves display values of referenced list items where the display pattern matches.
...
export class ListItemClient extends PictureparkClientBase {
     ...
     * @param patterns (optional) Comma-separated list of display pattern ids. Resolves display values of referenced list items where the display pattern id matches.
     */
...
export class PermissionClient extends PictureparkClientBase {
    ...
    /**
     * Has UserRight
     * @param userRight The UserRight to validate
