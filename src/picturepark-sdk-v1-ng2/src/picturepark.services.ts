...
export class ContentService extends PictureparkServiceBase {
    ...
    aggregate(contentAggregationRequest: ContentAggregationRequest): Observable<ObjectAggregationResult | null> {
        ...
        const content_ = JSON.stringify(contentAggregationRequest ? contentAggregationRequest.toJSON() : null);
    ...
    createContent(createRequest: CreateContentRequest, resolve: boolean, timeout: number, patterns: string[]): Observable<ContentDetail | null> {
        ...
        const content_ = JSON.stringify(createRequest ? createRequest.toJSON() : null);
    ...
    updateMetadata(contentId: string, updateRequest: UpdateContentMetadataRequest, resolve: boolean, timeout: number, patterns: string[]): Observable<ContentDetail | null> {
        ...
        const content_ = JSON.stringify(updateRequest ? updateRequest.toJSON() : null);
    ...
    search(contentSearchRequest: ContentSearchRequest): Observable<ContentSearchResult | null> {
        ...
        const content_ = JSON.stringify(contentSearchRequest ? contentSearchRequest.toJSON() : null);
    ...
    deactivateMany(deactivationRequest: ContentDeactivationRequest): Observable<BusinessProcessViewItem | null> {
        ...
        const content_ = JSON.stringify(deactivationRequest ? deactivationRequest.toJSON() : null);
    ...
    reactivateMany(reactivationRequest: ContentReactivationRequest): Observable<BusinessProcessViewItem | null> {
        ...
        const content_ = JSON.stringify(reactivationRequest ? reactivationRequest.toJSON() : null);
    ...
    updatePermissionsMany(updateRequest: UpdateContentPermissionsRequest[]): Observable<BusinessProcessViewItem | null> {
        ...
        if (updateRequest) {
            for (let item of updateRequest)
                contentData_.push(item.toJSON());
        }
        const content_ = JSON.stringify(updateRequest ? contentData_ : null);
...
export class ListItemService extends PictureparkServiceBase {
    ...
    create(listItem: ListItemCreateRequest, resolve: boolean, timeout: number, patterns: string[]): Observable<ListItemDetail | null> {
        ...
        const content_ = JSON.stringify(listItem ? listItem.toJSON() : null);
    ...
    createMany(objects: ListItemCreateRequest[]): Observable<BusinessProcessViewItem | null> {
        ...
        const content_ = JSON.stringify(objects ? contentData_ : null);
    ...
    aggregate(listItemAggregationRequest: ListItemAggregationRequest): Observable<ObjectAggregationResult | null> {
        ...
        const content_ = JSON.stringify(listItemAggregationRequest ? listItemAggregationRequest.toJSON() : null);
    ...
    search(listItemSearchRequest: ListItemSearchRequest): Observable<BaseResultOfListItem | null> {
        ...
        const content_ = JSON.stringify(listItemSearchRequest ? listItemSearchRequest.toJSON() : null);
...
export class SchemaService extends PictureparkServiceBase {
    ...
    update(schemaId: string, schema: SchemaUpdateRequest): Observable<BusinessProcessViewItem | null> {
        ...
        const content_ = JSON.stringify(schema ? schema.toJSON() : null);
    ...
    search(schemaSearchRequest: SchemaSearchRequest): Observable<BaseResultOfSchemaViewItem | null> {
        ...
        const content_ = JSON.stringify(schemaSearchRequest ? schemaSearchRequest.toJSON() : null);
...
export class FieldBase implements IFieldBase {
    ...
    static fromJS(data: any): FieldBase {
        ...
        if (data["Kind"] === "FieldInteger") {
            let result = new FieldInteger();
            result.init(data);
            return result;
        }
        if (data["Kind"] === "FieldIntegerArray") {
            let result = new FieldIntegerArray();
            result.init(data);
            return result;
        }
...
export class FieldInteger extends FieldBase implements IFieldInteger {
    pattern?: string | undefined;
    /** Defines the lowest possible value. */
    minimum?: number | undefined;
    /** Defines the highest possible value. */
    ...
    constructor(data?: IFieldInteger) {
        super(data);
        this._discriminator = "FieldInteger";
    }
    ...
    static fromJS(data: any): FieldInteger {
        if (data["Kind"] === "FieldIntegerArray") {
            let result = new FieldIntegerArray();
            result.init(data);
            return result;
...
export interface IFieldInteger extends IFieldBase {
    pattern?: string | undefined;
    /** Defines the lowest possible value. */
    minimum?: number | undefined;
    /** Defines the highest possible value. */
...
/** For internal use only (system schemas) */
export class FieldIntegerArray extends FieldInteger implements IFieldIntegerArray {
    uniqueItems: boolean;
    maximumItems?: number | undefined;
    minimumItems?: number | undefined;

    constructor(data?: IFieldIntegerArray) {
        super(data);
        this._discriminator = "FieldIntegerArray";
    }
    ...
    static fromJS(data: any): FieldIntegerArray {
        let result = new FieldIntegerArray();
        result.init(data);
        return result;
    }
...
/** For internal use only (system schemas) */
export interface IFieldIntegerArray extends IFieldInteger {
    uniqueItems: boolean;
    maximumItems?: number | undefined;
    minimumItems?: number | undefined;
}
...
export class PermissionSetSearchRequest implements IPermissionSetSearchRequest {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.limit = data["Limit"];
            this.filter = data["Filter"] ? FilterBase.fromJS(data["Filter"]) : <any>undefined;
            this.filterState = data["FilterState"] ? FilterBase.fromJS(data["FilterState"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["Limit"] = this.limit;
        data["Filter"] = this.filter ? this.filter.toJSON() : <any>undefined;
        data["FilterState"] = this.filterState ? this.filterState.toJSON() : <any>undefined;
        return data; 
    }
}
