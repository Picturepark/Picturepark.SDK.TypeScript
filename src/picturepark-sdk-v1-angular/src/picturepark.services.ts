...
export class ContentService extends PictureparkServiceBase {
     ...
     * @return ContentDoc
     */
    updateTransferOwnership(contentId: string, updateRequest: ContentOwnershipTransferRequest | undefined, timeout: number | undefined): Observable<ContentDetail | null> {
    ...
    transferOwnershipMany(contentsOwnershipTransferRequest: ContentsOwnershipTransferRequest | undefined): Observable<BusinessProcess | null> {
     ...
     */
    updateFile(contentId: string, updateRequest: ContentFileUpdateRequest | undefined): Observable<BusinessProcess | null> {
    ...
    deactivateMany(deactivationRequest: ContentDeactivationRequest | undefined): Observable<BusinessProcess | null> {
    ...
    reactivateMany(reactivationRequest: ContentReactivationRequest | undefined): Observable<BusinessProcess | null> {
     ...
     */
    updateMetadataMany(updateRequest: ContentsMetadataUpdateRequest | undefined): Observable<BusinessProcess | null> {
     ...
     * @return BusinessProcess
     */
    updatePermissionsMany(updateRequest: UpdateContentPermissionsRequest[] | undefined): Observable<BusinessProcess | null> {
...
export class BusinessProcessService extends PictureparkServiceBase {
    ...
    start(processDefinitionId: string, request: StartProcessRequest | undefined): Observable<BusinessProcess | null> {
...
export class ListItemService extends PictureparkServiceBase {
     ...
     * @return BusinessProcess
     */
    createMany(objects: ListItemCreateRequest[] | undefined): Observable<BusinessProcess | null> {
     ...
     * @return BusinessProcess
     */
    deleteMany(ids: string[] | undefined): Observable<BusinessProcess | null> {
        let url_ = this.baseUrl + "/V1/ListItems/Many?";
        if (ids !== undefined)
     ...
     * @return BusinessProcess
     */
    updateMany(objects: ListItemUpdateRequest[] | undefined): Observable<BusinessProcess | null> {
        let url_ = this.baseUrl + "/V1/ListItems/Many";
        url_ = url_.replace(/[?&]$/, "");
...
export class SchemaService extends PictureparkServiceBase {
     ...
     * @return SchemaDetail
     */
    getAll(ids: string[] | undefined): Observable<SchemaDetail[] | null> {
     ...
     * @return BusinessProcess
     */
    create(schema: SchemaCreateRequest | undefined): Observable<BusinessProcess | null> {
        let url_ = this.baseUrl + "/V1/Schemas";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return BusinessProcess
     */
    update(schemaId: string, schema: SchemaUpdateRequest | undefined): Observable<BusinessProcess | null> {
        let url_ = this.baseUrl + "/V1/Schemas/{SchemaId}";
        if (schemaId === undefined || schemaId === null)
            throw new Error("The parameter 'schemaId' must be defined.");
        url_ = url_.replace("{SchemaId}", encodeURIComponent("" + schemaId)); 
     ...
     */
    search(schemaSearchRequest: SchemaSearchRequest | undefined): Observable<BaseResultOfSchema | null> {
...
export class PublicAccessService extends PictureparkServiceBase {
    ...
    getShare(token: string | undefined): Observable<ShareBaseDetail | null> {
...
export class ShareService extends PictureparkServiceBase {
     ...
     * @return Share
     */
    update(id: string, updateRequest: ShareBaseUpdateRequest | undefined, resolve: boolean, timeout: number | undefined): Observable<BaseResultOfShareBase | null> {
     ...
     * @return BusinessProcess
     */
    deleteMany(shareIds: string[] | undefined): Observable<BusinessProcess | null> {
     ...
     */
    search(request: ContentSearchRequest | undefined): Observable<BaseResultOfShareBase | null> {
...
export class TransferService extends PictureparkServiceBase {
    ...
    create(request: CreateTransferRequest | undefined): Observable<Transfer | null> {
    ...
    importBatch(transferId: string, request: FileTransfer2ContentCreateRequest | undefined): Observable<Transfer | null> {
    ...
    partialImport(transferId: string, request: FileTransferPartial2ContentCreateRequest | undefined): Observable<Transfer | null> {
...
export class OutputService extends PictureparkServiceBase {
     ...
     */
    getByContentIds(contentsByIdsRequest: ContentsByIdsRequest | undefined): Observable<BaseResultOfOutputDetail | null> {
