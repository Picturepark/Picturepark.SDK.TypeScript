...
import { ShareDetail, IMailRecipient, InfoFacade, ShareDataBasic, ShareContentDetail, ShareService, PICTUREPARK_CONFIGURATION, PictureparkAccessTokenAuthConfiguration } from '@picturepark/sdk-v1-angular';
...
export class ShareDetailComponent implements OnInit {
  ...
  update(searchString: string): void {
    ...
    const shareInfo = forkJoin([
      this.shareService.getShareByToken(searchString, null, 'http://santest-cdn.01.qa-picturepark.com'),
