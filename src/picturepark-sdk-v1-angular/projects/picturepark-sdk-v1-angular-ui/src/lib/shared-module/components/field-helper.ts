...
export default class FieldHelper {
    ...
    static isReferencedField(field: FieldBase): boolean {
        const fieldType = field.constructor;
        return fieldType === FieldMultiTagbox
        || fieldType === FieldSingleTagbox
        || fieldType === FieldSingleFieldset;
    }
    ...
    static isAllowedField(field: FieldBase): boolean {
        const fieldType = field.constructor;
        return !(fieldType === FieldMultiRelation
        || fieldType === FieldSingleRelation
        || fieldType === FieldMultiFieldset);
    }

    static isMappable(field: FieldBase): boolean {
        const fieldType = field.constructor;
        return fieldType === FieldBoolean
        || fieldType === FieldDate
