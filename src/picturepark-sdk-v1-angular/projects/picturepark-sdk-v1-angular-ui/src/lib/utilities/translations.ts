export let TRANSLATIONS = {
  ...
  ContentDownloadDialog: {
    ...
    ConfirmDownloadMessage: {
      ...
      pt: 'O download está pronto. Quer continuar com o download?',
    },
    DownloadPending: {
    ...
    DownloadError: {
      ...
      pt: 'Ocorreu um problema com o download!',
    },
    TooManyContentsError: {
      ...
      pt: 'O download não pode conter mais de 1000 itens de conteúdo!',
    },
  },
  SchemaBrowser: {
    Ascending: {
  ...
  ShareContentDialog: {
    ...
    SuccessNotification: {
      ...
      pt: 'Seu conteúdo foi compartilhado com sucesso!',
    },
    ErrorNotification: {
  ...
  ReadMore: {
    More: { en: 'Show more', de: 'Mehr anzeigen', fr: 'Montrer plus', es: 'Mostrar más', pt: 'Mostre mais' },
    Less: { en: 'Show less', de: 'Weniger anzeigen', fr: 'Montrer moins', es: 'Muestra menos', pt: 'Mostre menos' },
  },
};
