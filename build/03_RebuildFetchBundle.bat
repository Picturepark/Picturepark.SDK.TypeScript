...
cmd /c call "node_modules/.bin/tsc-bundle" "%~dp0/../src/picturepark-sdk-v1-fetch/src/index.ts" "%~dp0/../src/picturepark-sdk-v1-fetch/dist/picturepark.js" --globalNamespace picturepark --declaration --target "ES5" --lib "DOM,ES5,ScriptHost,ES2015.Promise"
...
cmd /c call "node_modules/.bin/tsc" "%~dp0/../src/picturepark-sdk-v1-fetch/src/index.ts" --outFile "%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.js" --module amd --target "ES5" --lib "DOM,ES5,ScriptHost,ES2015.Promise" --declaration
...
cmd /c call "node_modules/.bin/uglifyjs" --compress --mangle -o "%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.js" -- "%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.js"
