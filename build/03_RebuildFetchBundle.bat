...
REM cmd /c powershell "& {(Get-Content '%~dp0/../src/picturepark-sdk-v1-fetch/dist/picturepark.d.ts') | ForEach-Object { $_ -replace 'export { AuthClient, AccessTokenAuthClient };', '' } | Set-Content '%~dp0/../src/picturepark-sdk-v1-fetch/dist/picturepark.d.ts'}"

REM cmd /c powershell "& { [System.IO.File]::ReadAllText('%~dp0/../src/picturepark-sdk-v1-fetch/dist/picturepark.d.ts') -replace '}\r\ndeclare module \"index\" {\r\n    import { AuthClient, AccessTokenAuthClient } from \"auth\";', '' | Set-Content '%~dp0/../src/picturepark-sdk-v1-fetch/dist/picturepark.d.ts'}"
...
REM cmd /c powershell "& {(Get-Content '%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.d.ts') | ForEach-Object { $_ -replace 'export { AuthClient, AccessTokenAuthClient };', '' } | Set-Content '%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.d.ts'}"

REM cmd /c powershell "& { [System.IO.File]::ReadAllText('%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.d.ts') -replace '}\r\ndeclare module \"index\" {\r\n    import { AuthClient, AccessTokenAuthClient } from \"auth\";', '' | Set-Content '%~dp0/../src/picturepark-sdk-v1-fetch/dist/amd/picturepark.d.ts'}"
