...
copy /b/v/y "%~dp0\..\src\picturepark-sdk-v1-pickers\dist\bundle.d.ts" "%~dp0\..\docs\temp\pictureparkPickers.d.ts"
...
cmd /c call "node_modules/.bin/typedoc" "%~dp0\..\docs\temp\pictureparkPickers.d.ts" --out "%~dp0\..\docs\picturepark-sdk-v1-pickers\api" --includeDeclarations --mode file --readme "%~dp0\..\docs\picturepark-sdk-v1-pickers\API.md" --theme default --name "picturepark-sdk-v1-pickers API"
