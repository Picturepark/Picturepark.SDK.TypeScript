...
cmd /c powershell "& {(Get-Content '%~dp0/../src/picturepark-sdk-v1-widgets/dist/picturepark-widgets.js') | ForEach-Object { $_ -replace ', \"libraries/liquid.min\", \"libraries/promise.min\", \"./libraries/fetch.min.js\"', '' } | Set-Content '%~dp0/../src/picturepark-sdk-v1-widgets/dist/picturepark-widgets.js'}"
