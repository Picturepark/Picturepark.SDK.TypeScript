...
cmd /c call npm publish "%~dp0\..\src\picturepark-sdk-v1-fetch\dist" --access=public
cmd /c call npm publish "%~dp0\..\src\picturepark-sdk-v1-pickers\dist" --access=public